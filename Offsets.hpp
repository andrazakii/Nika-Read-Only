...
// [Miscellaneous]
constexpr char OFF_GAME_VERSION[] = "v3.0.1.16"; //[Miscellaneous]->GameVersion
constexpr long OFF_ENTITY_LIST = 0x2022bf8; //[Miscellaneous]->cl_entitylist
constexpr long OFF_LOCAL_ENTITY_HANDLE = 0x1767248; //[Miscellaneous]->LocalEntityHandle
constexpr long OFF_LOCAL_PLAYER = 0x24F61E8; //[Miscellaneous]->LocalPlayer
